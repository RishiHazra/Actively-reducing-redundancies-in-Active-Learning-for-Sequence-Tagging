...
plt.title('Dataset: MIT Movie Corpus, Model: BiLSTM_BiLSTM_CRF, ALS: Margin', fontsize=14)
plt.xlabel('Percentage of data')
plt.ylabel('F-score')
plt.savefig('Dataset: MIT Movie corpus, Model: BiLSTM_BiLSTM_CRF, ALS: Margin.png')
#GENIA Corpus
#CoNLL 2003 (NER)
#MIT Movie